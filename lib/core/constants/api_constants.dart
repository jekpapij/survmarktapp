...
class ApiConstants {
  ...
  // finalisasi akun Google BARU (yang WAJIB milih role dulu di dialog
  // `LoginScreen`) sekarang endpoint TERPISAH dari `googleLogin` di atas —
  // lihat `AuthRemoteDataSourceImpl.completeGoogleRegistration`. Path
  // TEBAKAN juga, sama status-nya kayak `googleLogin`.
  static const String googleRegister = '/auth/google/complete';
